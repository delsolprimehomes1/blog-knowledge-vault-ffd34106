...
import { Users, ClipboardList, Video, Clock } from "lucide-react"
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Provider Portal: {user?.name}</h2>
                    <p className="text-muted-foreground">You have 4 appointments remaining today.</p>
                </div>
                <Button size="lg">
