...
serve(async (req) => {
  ...
  try {
    ...
    const { lead, agents, claimWindowMinutes, notification_type, lead_priority, assigned_agent_name, time_since_assignment_minutes }: NotificationRequest = await req.json();
